...
const ForgotPassword = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            let res = await axiosClient.post('/forget-password', { user_email: email })
            console.log(res)
        ...
        return (
            <>
                <div className='reset-pw-wrapper' >
                    <div className="alert-reset-pw" ><Alert variant="success">Email đã được gởi đến {email} Vui lòng kiểm tra email để tiếp tục bước tiếp theo.</Alert></div>
                </div>
            </>
        ...
        <>
            <div className='reset-pw-wrapper' >
                ...
                <Form className="reset-pw-form" onSubmit={handleSubmit}>
                    ...
                    {showLoader ? loader : <Button type="submit" className="btn" id="btn-confirm" disabled={disable}>
                        Xác nhận
                    </Button>}
                </Form>
